...
classDiagram
    ...
    class ProdutoService{
        ...
        +calcular_custo(produto)
    }

    %% RELACIONAMENTOS (Fluxo de Dependência)
    
    App --> Controller : Inicia e Roteia
    
    Controller ..> Service : Usa Lógica
    ProdutoController ..> ProdutoService
    
    Service ..> EntityModel : Manipula Dados
    ProdutoService ..> UsuarioModel 
    
    EntityModel ..> Database : Persiste Dados
    UsuarioModel --> Database
    
    %% Herança
    UsuarioModel --|> EntityModel
